...
@model({
  settings: {idInjection: false, postgresql: {schema: 'auth', table: 'user_tenant_prefs'}}
})
export class UserTenantPrefs extends Entity {
  @property({
    type: 'string',
...
export interface UserTenantPrefsRelations {
  // describe navigational properties here
}

export type UserTenantPrefsWithRelations = UserTenantPrefs & UserTenantPrefsRelations;
