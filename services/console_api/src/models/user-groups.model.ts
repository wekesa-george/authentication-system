...
@model({
  settings: {idInjection: false, postgresql: {schema: 'auth', table: 'user_groups'}}
})
export class UserGroups extends Entity {
  ...
  @property({
    ...
    jsonSchema: {nullable: false},
    generated: false,
    postgresql: {columnName: 'group_id', dataType: 'uuid', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'NO', generated: false},
  })
  groupId: string;
