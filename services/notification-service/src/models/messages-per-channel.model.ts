...
@model({
  settings: {
    idInjection: false,
    postgresql: {schema: 'notifications', table: 'messages_per_channel'}
  }
})
export class MessagesPerChannel extends Entity {
  @property({
    type: 'date',
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    postgresql: {columnName: 'message_id', dataType: 'integer', dataLength: null, dataPrecision: null, dataScale: 0, nullable: 'YES', generated: false},
  })
  messageId?: number;
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    postgresql: {columnName: 'template_id', dataType: 'integer', dataLength: null, dataPrecision: null, dataScale: 0, nullable: 'YES', generated: false},
  })
  templateId?: number;
  ...
  @property({
    ...
    length: 1,
    generated: false,
    postgresql: {columnName: 'delivery_status', dataType: 'character varying', dataLength: 1, dataPrecision: null, dataScale: null, nullable: 'YES', generated: false},
  })
  ...
  constructor(data?: Partial<MessagesPerChannel>) {
    super(data);
  }
}

export interface MessagesPerChannelRelations {
  // describe navigational properties here
}

export type MessagesPerChannelWithRelations = MessagesPerChannel & MessagesPerChannelRelations;
