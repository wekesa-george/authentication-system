...
import {OtpRepository} from '@sourceloop/authentication-service';
...
import {UserTenantRepository} from '@sourceloop/authentication-service';
export class UserRepositoryNew extends DefaultSoftCrudRepository<
  User,
