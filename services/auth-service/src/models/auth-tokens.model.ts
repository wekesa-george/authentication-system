...
@model({
  settings: {idInjection: false, postgresql: {schema: process.env.DB_SCHEMA??'auth', table: 'auth_tokens'}}
})
export class AuthTokens extends Entity {
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    postgresql: {columnName: 'user_tenant_id', dataType: 'character varying', dataLength: null, dataPrecision: null, dataScale: 0, nullable: 'NO', generated: false},
  })
  userTenantId: string;
